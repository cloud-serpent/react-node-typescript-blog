    ...
    <Footer>
      <MainContent>
        ...
        <ContentGroup>
          ...
          <ItemsGroup>
            <Item to={PATH.NOT_FOUND}>Travel</Item>
            <Item to={PATH.NOT_FOUND}>Technology</Item>
            <Item to={PATH.NOT_FOUND}>Lifestyle</Item>
            <Item to={PATH.NOT_FOUND}>Fashion</Item>
            <Item to={PATH.NOT_FOUND}>Business</Item>
          </ItemsGroup>
        </ContentGroup>
        <ContentGroup>
          <ContentTitle>
          ...
          <ItemsGroup>
            <Item to={PATH.NOT_FOUND}>FAQ</Item>
            <Item to={PATH.NOT_FOUND}>Terms and Conditions</Item>
            <Item to={PATH.NOT_FOUND}>Support</Item>
            <Item to={PATH.NOT_FOUND}>Privacy Policy</Item>
          </ItemsGroup>
        </ContentGroup>
        <ContentGroup>
          <ItemsGroup>
          ...
          <ItemsGroup>
            ...
            <FollowButtonsGroup>
              ...
              <FollowButton>
                ...
                >
                  <path
                    d="M2.0722 14H4.54031V7.6125H6.60409L6.91576 5.1275H4.54031V3.535C4.54031 2.8175 4.73406 2.3275 5.72804 2.3275H7V0.0962499C6.78099 0.0699999 6.03129 0 5.15523 0C3.31889 0 2.0722 1.16375 2.0722 3.29V5.1275H0V7.6125H2.0722V14Z"
                    fill="#777777"
                  />
                </svg>
              </FollowButton>
      ...
      <Copyright>
        <div>
          Designed by Darkking and Bighero & Developed by Telman and GOS
        </div>
      </Copyright>
    </Footer>
  );
